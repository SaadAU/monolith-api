...
export class CreateEventDto {
  ...
  @ApiProperty({
    ...
    required: false,
    example:
      'Join us for our annual technology conference featuring industry leaders.',
  })
  description?: string;
  ...
  @ApiProperty({
    ...
    required: false,
    example: 'Convention Center, Room 101',
  })
  location?: string;
  ...
  @IsEnum(EventStatus, {
    message:
      'Status must be one of: draft, submitted, approved, rejected, cancelled, completed',
  })
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Is the event virtual/online?',
    default: false,
    required: false,
  })
  isVirtual?: boolean;
  ...
  @ApiProperty({
    description: 'Virtual event URL (required if isVirtual is true)',
    required: false,
