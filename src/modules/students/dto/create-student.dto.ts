...
export class CreateStudentDto {
  ...
  @ApiProperty({ description: 'Student full name', minLength: 3, maxLength: 100, example: 'John Doe' })
  name!: string;
  ...
  @ApiProperty({ description: 'Student phone number', required: false, example: '+1-555-123-4567' })
  phone?: string;
  ...
  @ApiProperty({ description: 'Student enrollment number', example: 'ENR-2025-001' })
